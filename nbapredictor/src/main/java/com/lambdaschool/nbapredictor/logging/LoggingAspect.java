package com.lambdaschool.nbapredictor.logging;
...
{
    @Around(value = "@within(com.lambdaschool.nbapredictor.logging.Loggable) || @annotation(com.lambdaschool.nbapredictor.logging.Loggable)")
