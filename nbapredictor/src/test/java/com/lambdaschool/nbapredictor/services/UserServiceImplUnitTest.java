...
public class UserServiceImplUnitTest
{
    ...
    public void FA_saveResourceFound()
    {
        ...
        assertEquals("tiger@tiger.local", saveU2.getEmail());
    }
    ...
    public void G_update()
    {
        ...
        assertEquals("cinnamon@school.lambda", updatedu2.getEmail());
    }
    ...
    {
        userService.deleteUserRole(4, 1);
    }
